...
#include <rl_tools/rl/algorithms/qr_sac/loop/core/config.h>
#include <rl_tools/rl/loop/steps/extrack/config.h>
#include <rl_tools/rl/loop/steps/evaluation/config.h>
#include <rl_tools/rl/loop/steps/timing/config.h>
#include <rl_tools/rl/algorithms/qr_sac/loop/core/operations_generic.h>
...
struct LOOP_CORE_PARAMETERS: rlt::rl::algorithms::qr_sac::loop::core::DefaultParameters<TYPE_POLICY, TI, ENVIRONMENT>{
    struct QR_SAC_PARAMETERS: rlt::rl::algorithms::qr_sac::DefaultParameters<TYPE_POLICY, TI, ENVIRONMENT::ACTION_DIM>{
        static constexpr TI ACTOR_BATCH_SIZE = 100;
        static constexpr TI CRITIC_BATCH_SIZE = 100;
        static constexpr TI N_QUANTILES = 32;
    };
...
#ifdef BENCHMARK
using LOOP_CORE_CONFIG = rlt::rl::algorithms::qr_sac::loop::core::Config<TYPE_POLICY, TI, RNG, ENVIRONMENT, LOOP_CORE_PARAMETERS>;
using LOOP_TIMING_CONFIG = rlt::rl::loop::steps::timing::Config<LOOP_CORE_CONFIG>;
using LOOP_CONFIG = LOOP_TIMING_CONFIG;
#else
using RNG = DEVICE::SPEC::RANDOM::ENGINE<>;
using LOOP_CORE_CONFIG = rlt::rl::algorithms::qr_sac::loop::core::Config<TYPE_POLICY, TI, RNG, ENVIRONMENT, LOOP_CORE_PARAMETERS, rlt::rl::algorithms::qr_sac::loop::core::ConfigApproximatorsMLP>;
