#include "../../../../../version.h"
#if (defined(RL_TOOLS_DISABLE_INCLUDE_GUARDS) || !defined(RL_TOOLS_RL_ALGORITHMS_QR_SAC_LOOP_CORE_APPROXIMATORS_MLP_H)) && (RL_TOOLS_USE_THIS_VERSION == 1)
#pragma once
#define RL_TOOLS_RL_ALGORITHMS_QR_SAC_LOOP_CORE_APPROXIMATORS_MLP_H

RL_TOOLS_NAMESPACE_WRAPPER_START
namespace rl_tools::rl::algorithms::qr_sac::loop::core{
    // Same structure as the sac approximators, but the critic MLP outputs N_QUANTILES values
    ...
    struct ConfigApproximatorsMLP{
        ...
        struct Actor{
            using INPUT_SHAPE = tensor::Shape<TI, QR_SAC_PARAMETERS::SEQUENCE_LENGTH, QR_SAC_PARAMETERS::ACTOR_BATCH_SIZE, ENVIRONMENT::Observation::DIM>;
        ...
        struct Critic{
            ...
            using INPUT_SHAPE = tensor::Shape<TI, QR_SAC_PARAMETERS::SEQUENCE_LENGTH, QR_SAC_PARAMETERS::CRITIC_BATCH_SIZE, INPUT_DIM>;
            using MLP_CONFIG = nn_models::mlp::Configuration<TYPE_POLICY, TI, QR_SAC_PARAMETERS::N_QUANTILES, PARAMETERS::CRITIC_NUM_LAYERS, PARAMETERS::CRITIC_HIDDEN_DIM, PARAMETERS::CRITIC_ACTIVATION_FUNCTION, nn::activation_functions::IDENTITY, typename PARAMETERS::INITIALIZER>;
            using MLP = nn_models::mlp::BindConfiguration<MLP_CONFIG>;
            template <typename T_CONTENT, typename T_NEXT_MODULE = nn_models::sequential::OutputModule>
            using Module = typename nn_models::sequential::Module<T_CONTENT, T_NEXT_MODULE>;
