#include "../../../../../version.h"
#if (defined(RL_TOOLS_DISABLE_INCLUDE_GUARDS) || !defined(RL_TOOLS_RL_ALGORITHMS_QR_SAC_LOOP_CORE_CONFIG_H)) && (RL_TOOLS_USE_THIS_VERSION == 1)
#pragma once
#define RL_TOOLS_RL_ALGORITHMS_QR_SAC_LOOP_CORE_CONFIG_H
...
namespace rl_tools::rl::algorithms::qr_sac::loop::core{
    // Config State (Init/Step)
    template<typename TYPE_POLICY, typename TI, typename ENVIRONMENT>
    struct DefaultParameters{
        using QR_SAC_PARAMETERS = rl::algorithms::qr_sac::DefaultParameters<TYPE_POLICY, TI, ENVIRONMENT::ACTION_DIM>;
        ...
        static_assert(N_WARMUP_STEPS >= QR_SAC_PARAMETERS::ACTOR_BATCH_SIZE);
        ...
        using BATCH_SAMPLING_PARAMETERS = rl::components::off_policy_runner::SequentialBatchParameters<TYPE_POLICY, TI, QR_SAC_PARAMETERS::SEQUENCE_LENGTH, rl::components::off_policy_runner::SequentialBatchParametersDefault>;
    ...
    struct Config{
        ...
        using ACTOR_CRITIC_SPEC = rl::algorithms::qr_sac::Specification<TYPE_POLICY, TI, ENVIRONMENT, typename NN::ACTOR_TYPE, typename NN::CRITIC_TYPE, typename NN::CRITIC_TARGET_TYPE, ALPHA_PARAMETER_TYPE, typename NN::ACTOR_OPTIMIZER, typename NN::CRITIC_OPTIMIZER, typename NN::ALPHA_OPTIMIZER, typename CORE_PARAMETERS::QR_SAC_PARAMETERS, CORE_PARAMETERS::BATCH_SAMPLING_PARAMETERS::INCLUDE_FIRST_STEP_IN_TARGETS>;
        using ACTOR_CRITIC_TYPE = rl::algorithms::qr_sac::ActorCritic<ACTOR_CRITIC_SPEC>;
        ...
        struct OFF_POLICY_RUNNER_PARAMETERS{
            ...
            static constexpr T GAMMA = CORE_PARAMETERS::QR_SAC_PARAMETERS::GAMMA_BASE;
        ...
        static constexpr TI TARGET_SEQUENCE_LENGTH = CORE_PARAMETERS::QR_SAC_PARAMETERS::SEQUENCE_LENGTH + (CORE_PARAMETERS::BATCH_SAMPLING_PARAMETERS::INCLUDE_FIRST_STEP_IN_TARGETS ? 1 : 0);

        static constexpr TI DEFAULT_SEQUENCE_LENGTH = DefaultParameters<TYPE_POLICY, TI, ENVIRONMENT>::QR_SAC_PARAMETERS::SEQUENCE_LENGTH;
        ...
        static_assert(CORE_PARAMETERS::QR_SAC_PARAMETERS::SEQUENCE_LENGTH == DEFAULT_SEQUENCE_LENGTH || !USING_DEFAULT_BATCH_SAMPLING_PARAMETERS, "When setting a custom sequence length, please study and set custom batch sampling parameters.");
