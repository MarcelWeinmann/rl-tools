#include "../../../../../version.h"
#if (defined(RL_TOOLS_DISABLE_INCLUDE_GUARDS) || !defined(RL_TOOLS_RL_ALGORITHMS_QR_SAC_LOOP_CORE_STATE_H)) && (RL_TOOLS_USE_THIS_VERSION == 1)
#pragma once
#define RL_TOOLS_RL_ALGORITHMS_QR_SAC_LOOP_CORE_STATE_H
...
namespace rl_tools{
    namespace rl::algorithms::qr_sac::loop::core{
        ...
        struct State{
            ...
            rl::algorithms::qr_sac::CriticTrainingBuffers<rl::algorithms::qr_sac::CriticTrainingBuffersSpecification<typename CONFIG::ACTOR_CRITIC_SPEC, CONFIG::DYNAMIC_ALLOCATION>> critic_training_buffers[2];
            Matrix<matrix::Specification<T_INPUT, TI, CONFIG::TARGET_SEQUENCE_LENGTH * CONFIG::CORE_PARAMETERS::QR_SAC_PARAMETERS::CRITIC_BATCH_SIZE, CONFIG::ENVIRONMENT::ACTION_DIM, CONFIG::DYNAMIC_ALLOCATION>> action_noise_critic;
            ...
            rl::algorithms::qr_sac::ActorTrainingBuffers<rl::algorithms::qr_sac::ActorTrainingBuffersSpecification<typename CONFIG::ACTOR_CRITIC_TYPE::SPEC, CONFIG::DYNAMIC_ALLOCATION>> actor_training_buffers;
            Matrix<matrix::Specification<T_INPUT, TI, CONFIG::CORE_PARAMETERS::QR_SAC_PARAMETERS::SEQUENCE_LENGTH * CONFIG::CORE_PARAMETERS::QR_SAC_PARAMETERS::CRITIC_BATCH_SIZE, CONFIG::ENVIRONMENT::ACTION_DIM, CONFIG::DYNAMIC_ALLOCATION>> action_noise_actor;
    ...
    template <typename T_CONFIG>
    constexpr auto& get_actor(rl::algorithms::qr_sac::loop::core::State<T_CONFIG>& ts){
        return ts.actor_critic.actor;
    }
    template <typename T_CONFIG>
    constexpr auto& get_critic_1(rl::algorithms::qr_sac::loop::core::State<T_CONFIG>& ts){
        return ts.actor_critic.critics_target[0];
    }
    template <typename T_CONFIG>
    constexpr auto& get_critic_2(rl::algorithms::qr_sac::loop::core::State<T_CONFIG>& ts){
