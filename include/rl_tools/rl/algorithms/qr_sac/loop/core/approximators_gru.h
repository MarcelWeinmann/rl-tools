#include "../../../../../version.h"
#if (defined(RL_TOOLS_DISABLE_INCLUDE_GUARDS) || !defined(RL_TOOLS_RL_ALGORITHMS_QR_SAC_LOOP_CORE_APPROXIMATORS_GRU_H)) && (RL_TOOLS_USE_THIS_VERSION == 1)
#pragma once
#define RL_TOOLS_RL_ALGORITHMS_QR_SAC_LOOP_CORE_APPROXIMATORS_GRU_H

RL_TOOLS_NAMESPACE_WRAPPER_START
namespace rl_tools::rl::algorithms::qr_sac::loop::core{
    // Same structure as the sac GRU approximators, but the critic output layer emits N_QUANTILES values
    ...
    struct ConfigApproximatorsGRU{
        ...
        using QR_SAC_PARAMETERS = typename PARAMETERS::QR_SAC_PARAMETERS;
        template <typename CAPABILITY>
        struct Actor{
            using INPUT_SHAPE = tensor::Shape<TI, QR_SAC_PARAMETERS::SEQUENCE_LENGTH, PARAMETERS::QR_SAC_PARAMETERS::ACTOR_BATCH_SIZE, ENVIRONMENT::Observation::DIM>;
            ...
            struct SAMPLE_AND_SQUASH_LAYER_PARAMETERS{
                ...
                static constexpr T LOG_STD_LOWER_BOUND = QR_SAC_PARAMETERS::LOG_STD_LOWER_BOUND;
                static constexpr T LOG_STD_UPPER_BOUND = QR_SAC_PARAMETERS::LOG_STD_UPPER_BOUND;
                static constexpr T LOG_PROBABILITY_EPSILON = QR_SAC_PARAMETERS::LOG_PROBABILITY_EPSILON;
                static constexpr bool ADAPTIVE_ALPHA = QR_SAC_PARAMETERS::ADAPTIVE_ALPHA;
                static constexpr bool UPDATE_ALPHA_WITH_ACTOR = false;
                static constexpr T ALPHA = QR_SAC_PARAMETERS::ALPHA;
                static constexpr T TARGET_ENTROPY = QR_SAC_PARAMETERS::TARGET_ENTROPY;
            };
        ...
        struct Critic{
            ...
            using INPUT_SHAPE = tensor::Shape<TI, QR_SAC_PARAMETERS::SEQUENCE_LENGTH, PARAMETERS::QR_SAC_PARAMETERS::CRITIC_BATCH_SIZE, INPUT_DIM>;
            ...
            using DENSE_LAYER = nn::layers::dense::BindConfiguration<DENSE_LAYER_CONFIG>;
            using OUTPUT_LAYER_CONFIG = nn::layers::dense::Configuration<TYPE_POLICY, TI, QR_SAC_PARAMETERS::N_QUANTILES, nn::activation_functions::ActivationFunction::IDENTITY, nn::layers::dense::DefaultInitializer<TYPE_POLICY, TI>, nn::parameters::groups::Output>;
            using OUTPUT_LAYER = nn::layers::dense::BindConfiguration<OUTPUT_LAYER_CONFIG>;
            template <typename T_CONTENT, typename T_NEXT_MODULE = nn_models::sequential::OutputModule>
            using Module = typename nn_models::sequential::Module<T_CONTENT, T_NEXT_MODULE>;
